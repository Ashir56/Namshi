    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shipping_cost', models.FloatField(default=0.0, max_length=500)),
                ...
                ('order_status', models.PositiveIntegerField(choices=[(1, 'PENDING'), (2, 'CONFIRMED'), (3, 'PACKED'), (4, 'SHIPPED'), (5, 'IN WAY'), (6, 'ARRIVED DESTINATION'), (7, 'RECEIVED'), (8, 'COMPLETED')], default=1, max_length=2)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Buyer.order')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Product.product')),
                ('variant', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Product.productvariant')),
            ],
        ),
        migrations.AddField(
            model_name='order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_type', models.CharField(choices=[('HO', 'House'), ('OF', 'Office')], default='HO', max_length=2)),
                ('buyer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Buyer.buyer')),
            ],
        ),
    ]
