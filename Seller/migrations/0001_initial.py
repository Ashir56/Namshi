    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('ME', 'Men'), ('WO', 'Women'), ('KI', 'Kid'), ('BE', 'Beauty')], default='ME', max_length=2)),
                ...
                ('product_sizeType', models.CharField(choices=[('US', 'USA'), ('UK', 'UKingdom'), ('IN', 'International')], default='IN', max_length=2)),
                ...
                ('product_subcategory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Seller.subcategory')),
            ],
        ),
    ]
